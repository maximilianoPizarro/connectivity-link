...
**⚠️ Important**: This repository contains demo cluster domain references (`apps.cluster-wmdrk.wmdrk.sandbox2484.opentlc.com`) that must be updated to match your OpenShift cluster's base domain before deployment.
...
If you prefer to update manually, search and replace `apps.cluster-wmdrk.wmdrk.sandbox2484.opentlc.com` with your cluster's base domain in the following locations:

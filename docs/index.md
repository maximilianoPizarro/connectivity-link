...
**⚠️ Important**: This repository contains demo cluster domain references (`apps.cluster-k82pl.dynamic.redhatworkshops.io`) that must be updated to match your OpenShift cluster's base domain before deployment.
...
If you prefer to update manually, search and replace `apps.cluster-k82pl.dynamic.redhatworkshops.io` with your cluster's base domain in the following locations:
